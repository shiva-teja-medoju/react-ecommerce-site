...
import "../../../components/product/Products/Products.css";
import { addToCart } from "../../cart/redux/cartSlice";
import { useDispatch } from "react-redux";
import { Link } from "react-router-dom";
import { ProductsNotFound } from "../../../components/ui/EmptyState/ProductsNotFound";
...
const MiscellaneousSection: React.FC = () => {
  ...
  const miscProducts = products.filter(
    (p) => p.category?.name.toLowerCase().includes("miscellaneous")
  );
